...
const { syncHeroCustomersToFirestore } = require('../lib/syncCustomers')
const { writeHeroSyncLog } = require('../lib/syncLog')
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const stats = await syncHeroCustomersToFirestore()
    ...
    console.error('HERO Kunden-Sync Fehler:', error)
    ...
    try {
      ...
      await writeHeroSyncLog({
        type: 'customers',
        success: false,
        message: 'Kunden-Sync fehlgeschlagen',
